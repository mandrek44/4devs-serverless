...
namespace FunctionApp1
{
    public static class ResizePicture
    {
        ...
        public static async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = null)]HttpRequest req,
            [Blob("photos", FileAccess.Read, Connection = "OrdersStorage")]CloudBlobContainer photosContainer,
            [Blob("doneorders/{rand-guid}", FileAccess.ReadWrite, Connection = "OrdersStorage")]ICloudBlob resizedPhotoCloudBlob,
            TraceWriter log)
        {
